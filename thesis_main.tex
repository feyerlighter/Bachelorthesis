...
\lstdefinelanguage{Python}{
	keywords={import, from, def, return, if, elif, else, for, while, break, continue, pass, lambda, try, except, raise, with, as, class, yield, global, nonlocal, assert, del, in, is, and, or, not},
	keywordstyle=\color{blue}\bfseries,
...
\lstdefinelanguage{JSON}{
	...
	morestring=[b]',
	morestring=[b]",
	moredelim=[s][\color{orange}]{:}{\ } % Highlight für Doppelpunkte
}
...
% Ändert den Titel im Verzeichnis
\renewcommand{\lstlistlistingname}{List of Codes}

% Ändert die Beschriftung der Listings
