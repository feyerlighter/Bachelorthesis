...
In
Kapitel~\ref{requirementengineering}~\nameref{requirementengineering} findet ihr wichtige Anmerkungen zu \LaTeX{}
...
\autocite[cf.][pp. 1-2]{liResearchSinglePage2021} It is effective for developing a chatbot interface that needs to present
complex data in an accessible manner, while also allowing for dynamic updates based on user interactions.
