...
% todo Hinzufügen von Modular Design weil Floyd sagt "Used as a technique, simulation is clearly dependet on modular design, which permits simulation to be made locally without affecting the system structure as a whole.
